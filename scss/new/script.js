...
function enterDate(e){
  document.getElementByClassName("dateoneOne").classList.toggle("dateoneOne-toggle");
...
function toggleLeftSideBar(e) {
  ...
  //innerSpan.toggleClass("innerspan-collapse");
